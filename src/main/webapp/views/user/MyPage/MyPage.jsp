...
<link rel="stylesheet"
	href="http://localhost:8888/always5/resources/user_css/MyPage.css" />
</head>
<body>
<div class="Mypage">
      ...
      <div class="Mypage-main-logo">
        <div class="Mypage-username">왕고기</div>
        <div class="Mypage-usergrade">밥백성(회원)</div>

        <div class="Mypage-main-icon">
          <img class="Mypage-icon-crown" src="../../../resources/file/upfile/mypage_upfile/myPage-img/image.png" />
          <img class="Mypage-line" src="../../../resources/file/upfile/mypage_upfile/myPage-img/line-44.svg" />
      ...
      <div class="Mypage-profile">
        ...
        <div class="Mypage-username-box">
          <div class="profile-username">왕고기</div>
        ...
        <div class="Mypage-userid-box">
          <div class="profile-userid">aaaa@gmail.com</div>
        ...
        <div class="Mypage-userpwd-box">
          <div class="profile-userpwd">gb*******</div>
      ...
      <div class="Mypage-option">
        ...
        <img class="Mypage-option-img" src="../../../resources/file/upfile/mypage_upfile/myPage-img/line-44.svg" />
