...
<link rel="stylesheet"
	href="http://localhost:8888/always5/resources/user_css/SearchPwd02.css" />
</head>
		...
		<div class="SearchPwd02-Verification">
			<div class="SearchPwd02-main">
				<img class="SearchPwd02-main-image"
					src="http://localhost:8888/always5/resources/file/upfile/user_upfile/SearchPwd02-img/2x.png" />
			</div>
		</div>
		...
		<div class="password-Verification">
			<div class="password-Verification-box">
				...
				<img class="password-Verification-line"
					src="http://localhost:8888/always5/resources/file/upfile/user_upfile/SearchPwd02-img/line-46.svg" />
