...
<link rel="stylesheet"
	href="http://localhost:8888/always5/resources/user_css/SearchPwd.css" />
</head>
	...
	<div class="SearchPwd">
		...
		<div class="SearchPwd-main">
			<img class="SearchPwd-main-image"
				src="http://localhost:8888/always5/resources/file/upfile/user_upfile/SearchPwd-img/2x.png" />
		</div>
