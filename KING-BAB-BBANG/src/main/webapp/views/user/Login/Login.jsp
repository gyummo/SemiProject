...
<link rel="stylesheet"
	href="http://localhost:8888/always5/resources/user_css/logIn.css" />
</head>
<body>
	<div class="login">
		...
		<div class="login-logo-main">
			<img class="logo-image"
				src="http://localhost:8888/always5/resources/file/upfile/user_upfile/login-img/logo.png" />
		</div>
		...
		<div class="login-main-box">
			...
			<div class="authority-box">
				...
				<img class="authority-line"
					src="http://localhost:8888/always5/resources/file/upfile/user_upfile/login-img/line-40.svg" />
				...
				<div class="login-input-box">
					...
					<div class="login-option">
						...
						<img class="login-option-line1"
							src="http://localhost:8888/always5/resources/file/upfile/user_upfile/login-img/line-41.svg" />
						<div class="login-option-searchPwd">비밀번호 찾기</div>
						<img class="login-option-line2"
							src="http://localhost:8888/always5/resources/file/upfile/user_upfile/login-img/line-42.svg" />
