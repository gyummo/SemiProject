...
<link rel="stylesheet"
	href="http://localhost:8888/always5/resources/user_css/Verification.css" />
</head>
<body>
	<div class="Verification">
		...
		<!-- X버튼 -->
		<img class="logo"
			src="http://localhost:8888/always5/resources/file/upfile/user_upfile/Verification-img/ph-x-thin.svg" />

		<!-- 본인인증 로고 -->
		<div class="Verification-main">
			<img class="Verification-image"
				src="http://localhost:8888/always5/resources/file/upfile/user_upfile/Verification-img/2x.png" />
		</div>
